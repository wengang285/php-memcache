...
$begin = time();
for($i=0;$i<100000;$i++){
	$iRet=CommMemcache::set("test_key_{$i}","test_value",MEMCACHE_COMPRESSED,300);
	if($iRet===false){
		echo "set false {$i}\n";
	}
}
...
$iRet=CommMemcache::set("test_array",$info,MEMCACHE_COMPRESSED,10);
...
print_r(CommMemcache::get("test_array"));
*/
